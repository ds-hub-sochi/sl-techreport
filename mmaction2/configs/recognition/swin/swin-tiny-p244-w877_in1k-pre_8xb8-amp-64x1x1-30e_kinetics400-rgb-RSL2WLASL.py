...
model = dict(
    ...
    data_preprocessor=dict(
        ...
        blending=dict(
            ...
            augments=[
                dict(type='MixupBlending', alpha=0.8, num_classes=2000),
                dict(type='CutmixBlending', alpha=1, num_classes=2000)
            ])),
    cls_head=dict(
        type='I3DHead',
        in_channels=768,
...
default_hooks = dict(
    checkpoint=dict(interval=1, max_keep_ckpts=30), logger=dict(interval=100))
...
work_dir = './work_dirs/swin-tiny-kinetic-RSL-WLASL'
